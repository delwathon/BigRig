<div 
    class="flex-grow h-screen flex flex-col md:translate-x-0 duration-300 ease-in-out overflow-hidden"
...
>
    <!-- Header -->
        <div class="sticky top-0 z-10">
            <div class="flex items-center justify-between before:absolute before:inset-0 before:backdrop-blur-md before:bg-gray-50/90 dark:before:bg-[#151D2C]/90 before:-z-10 border-b border-gray-200 dark:border-gray-700/60 px-4 sm:px-6 md:px-5 h-16">
                ...
                <div class="flex text-left">
                    <a class="block" href="javascript:void(0)">{{ $receiver->firstName}}</a>
                </div>
        ...
        <div class="flex-grow overflow-y-auto px-4 sm:px-6 md:px-5 py-6">
            @foreach ($messages as $msg)
                <div class="flex items-start mb-4 last:mb-0">
                    ...
                    />
                    <div>
                        <div class="{{ $msg['sender_id'] === Auth::id() ? 'text-sm bg-violet-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent mb-1' : 'text-sm bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 p-3 rounded-lg rounded-tl-none mb-1' }}">
                            {{ $msg['body'] }}
                        </div>
            ...
            <div class="flex items-center justify-between bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700/60 px-4 sm:px-6 md:px-5 h-16">
                ...
                <form wire:submit.prevent="sendMessage" class="grow flex">
                    <div class="grow mr-3">
                        ...
                        <textarea id="message-input" wire:model.defer="body" col="1" class="form-input w-full bg-gray-100 dark:bg-gray-800 border-transparent dark:border-transparent focus:bg-white dark:focus:bg-gray-800 placeholder-gray-500" placeholder="Type a message..."></textarea>
                    </div>
