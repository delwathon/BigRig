                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <div class="sec-title">
                                ...
                                <a href="{{route('courses')}}" class="theme-btn btn-five">get suggestion</a>
                            </div>
                            <div class="inner-box">
                                <!-- <div class="text">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                            <div class="single-item">
                                                ...
                                                <h6><a href="{{ route('home')}}">Theory Session</a></h6>
                                                <span>06 Hours</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                            <div class="single-item">
                                                ...
                                                <h6><a href="{{ route('home')}}">Practical Session</a></h6>
                                                <span>25 Hours</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 chooseus-block">
                        <div class="chooseus-block-one wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h4><a href="{{ route('home')}}">Trained <br />Instructors</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 chooseus-block">
                        <div class="chooseus-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h4><a href="{{ route('home')}}">Fair <br />Pricing Plans</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 chooseus-block">
                        <div class="chooseus-block-one wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h4><a href="{{ route('home')}}">Well Maintained <br />Vehicles</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 chooseus-block">
                        <div class="chooseus-block-one wow fadeInLeft animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h4><a href="{{ route('home')}}">Best <br />Safety Measures</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 chooseus-block">
                        <div class="chooseus-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h4><a href="{{ route('home')}}">Pick Up & <br />Drop Off On Time</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 chooseus-block">
                        <div class="chooseus-block-one wow fadeInRight animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h4><a href="{{ route('home')}}">Flexible Course <br />Completion</a></h4>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                            <div class="content-box">
                                ...
                                <a href="{{route('contact')}}" class="theme-btn btn-five">View More</a>
                            </div>
                        </div>
