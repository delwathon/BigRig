            ...
            <div class="menu-area">
                ...
                <nav class="main-menu navbar-expand-md navbar-light">
                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                        ...
                        <li class="{{ Request::is('/') ? 'current' : '' }} dropdown"><a href="{{ url('/') }}">Home</a></li>
                        <li class="{{ Request::is('about') ? 'current' : '' }} dropdown"><a href="{{ url('about') }}">About</a></li>
                        <li class="{{ Request::is('courses') ? 'current' : '' }} dropdown"><a href="{{ url('courses') }}">Courses</a></li>
                        <li class="{{ Request::is('faq') ? 'current' : '' }} dropdown"><a href="{{ url('faq') }}">FAQ'S</a></li>
                        <li class="{{ Request::is('contact') ? 'current' : '' }} dropdown"><a href="{{ url('contact') }}">Contact</a></li>
                        </ul>
                    </div>
                </nav>
                <div class="menu-right">
                    ...
                    <div class="btn-box">
                        <a href="{{url('auth/register-basic')}}" class="theme-btn btn-one">Get Started</a>
                    </div>
                </div>
