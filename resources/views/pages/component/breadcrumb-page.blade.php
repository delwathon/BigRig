                        ...
                        <div class="text-center">
                            ...
                            <ul class="inline-flex flex-wrap text-sm font-medium">
                                <li class="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                                    <a class="text-gray-500 dark:text-gray-400 hover:text-violet-500 dark:hover:text-violet-500" href="javascript:void(0)">Home</a>
                                </li>
                                <li class="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                                    <a class="text-gray-500 dark:text-gray-400 hover:text-violet-500 dark:hover:text-violet-500" href="javascript:void(0)">Settings</a>
                                </li>
                                <li class="after:content-['/'] last:after:hidden after:text-gray-400 dark:after:text-gray-600 after:px-2">
                                    <a class="text-gray-500 dark:text-gray-400 hover:text-violet-500 dark:hover:text-violet-500" href="javascript:void(0)">Notifications</a>
                                </li>
                            </ul>
                            <!-- End -->
                        </div>
