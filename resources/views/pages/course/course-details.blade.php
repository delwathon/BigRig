    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 italic mb-2">Introduced on {{ \Carbon\Carbon::parse($objective->created_at)->format('M j, Y') }}</div>
                <header class="mb-4">
                    <!-- Title -->
                    <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{{ $objective->objective }}</h1>
                </header>
                ...
                <div class="mb-6">
                    <div class="flex flex-wrap items-center -m-1">
                        <div class="m-1">
                            <a class="btn-xs text-xs border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 px-2.5 py-1 rounded-full shadow-none" href="#0">{{ $objective->duration }} weeks course</a>
                        </div>
                    </div>
                </div>
                ...
                <!-- The Role -->
                <div>
                    <h2 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-2">Course Requirements</h2>
                    <div class="space-y-6">
                        <p>The following are required to participate in the {{ strtolower($objective->objective) }} course</p>
                        <ul>
                ...
                <!-- Related Jobs -->
                <div>
                    <h2 class="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-6">Class Schedule / Curriculum</h2>
