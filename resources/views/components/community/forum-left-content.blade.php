    ...
    <div class="md:sticky md:top-16 md:h-[calc(100dvh-64px)] md:overflow-x-hidden md:overflow-y-auto no-scrollbar">
        <div class="md:py-8">
            ...
            <div class="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-4 md:space-y-3 -mx-4">
                ...
                <div>
                    ...
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap bg-white dark:bg-gray-800" href="{{ route('forum.list') }}">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="javascript:void(0)">
                                <svg class="shrink-0 fill-current text-gray-400 dark:text-gray-500 mr-2" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M14.682 2.318A4.485 4.485 0 0 0 11.5 1 4.377 4.377 0 0 0 8 2.707 4.383 4.383 0 0 0 4.5 1a4.5 4.5 0 0 0-3.182 7.682L8 15l6.682-6.318a4.5 4.5 0 0 0 0-6.364Z" />
                                </svg>
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-300">My Reading List</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <!-- Categories / Groups -->
                <div>
                    <div class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-3">Categories</div>
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        @foreach ($categories as $category)
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="{{ route('forum.list', ['category' => $category->slug]) }}">
                                ...
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-300">{{ $category->name }}</span>
                            </a>
                        </li>
                        @endforeach
                    </ul>
