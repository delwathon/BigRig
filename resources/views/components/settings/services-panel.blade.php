        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-auto max-w-lg w-full max-h-full" 
            ...
            <div class="px-5 py-3 border-b border-gray-200 dark:border-gray-700/60">
                <div class="flex justify-between items-center">
                    <div class="font-semibold text-gray-800 dark:text-gray-100">Add New Custom Service</div>
            ...
            <!-- Modal content -->
            <form method="POST" action="{{ route('custom-service.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="px-5 py-4">
                    <div class="space-y-3 mt-3">
                        ...
                        <div>
                            ...
                            <input id="service_name" class="form-input w-full px-2 py-1" type="text" name="service_name" required />
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1" for="service_description">Brief Description <span class="text-red-500">*</span></label>
                ...
                <div class="px-5 py-4 border-t border-gray-200 dark:border-gray-700/60">
                    <div class="flex flex-wrap justify-end space-x-2">
                        <button class="btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300" @click="$store.createModal.close()">Cancel</button>
            ...
            <form method="POST" action="{{ route('custom-service.update') }}" enctype="multipart/form-data">
                ...
                <div class="px-5 py-4">
                    <div class="space-y-3 mt-3">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1" for="service_picture">Picture Upload</label>
            ...
            <div class="p-5 flex space-x-4">
                ...
                <div>
                    ...
                    <div class="text-sm mb-10">
                        <div class="space-y-2">
                            <p>You are about to delete a custom service, this action cannot be undone. Do you want to proceed?</p>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="flex flex-wrap justify-end space-x-2">
                        ...
                        <form x-bind:action="`/settings/custom-service/destroy/${$store.deleteModal.serviceIid}`" method="POST">
                            @csrf
                            @method('GET')
