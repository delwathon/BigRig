                        ...
                        <tr class="flex flex-wrap md:table-row md:flex-no-wrap border-b border-gray-200 dark:border-gray-700/60 py-2 md:py-0">
                            <td class="w-full block md:w-auto md:table-cell py-0.5 md:py-2">
                                <div class="flex items-center">
                                    <div class="font-medium text-gray-800 dark:text-gray-100">{{ $enrolment_batch->batch_name }}</div>
                                </div>
                            </td>
                            <td class="w-full block md:w-auto md:table-cell py-0.5 md:py-2">
                                <div class="flex items-center">
                                    <div class="font-medium text-gray-800 dark:text-gray-100">{{ $enrolment_batch->commencement_date }}</div>
                                </div>
                            </td>
                            <td class="w-full block md:w-auto md:table-cell py-0.5 md:py-2">
