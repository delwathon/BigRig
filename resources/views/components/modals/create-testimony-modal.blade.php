        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-auto max-w-4xl w-full max-h-full" @click.stop>
            ...
            <div class="px-5 py-3 border-b border-gray-200 dark:border-gray-700/60">
                <div class="flex justify-between items-center">
                    <div class="font-semibold text-gray-800 dark:text-gray-100">Add New Testimony</div>
                ...
                <div class="px-5 py-4">
                    <div class="space-y-3 mt-3">
                        ...
                        <div class="flex gap-4">
                            <div class="sm:w-2/5">
                                <label class="block text-sm font-medium mb-1" for="full_name">Full Name <span class="text-red-500">*</span></label>
                                <input id="full_name" class="form-input w-full px-2 py-1" type="text" name="full_name"  />
                            </div>
                            <div class="sm:w-2/5">
                            ...
                            <div class="sm:w-1/5">
                                ...
                                <input id="rating" class="form-input w-full px-2 py-1" type="number" name="rating"  />
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1" for="testimony">Testimony <span class="text-red-500">*</span></label>
                            <textarea name="testimony" class="form-textarea w-full px-2 py-1" id="editor" rows="10" cols="80"></textarea>
                        </div>
                    </div>
                </div>
