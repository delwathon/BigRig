            ...
            <div class="p-5 flex space-x-4">
                ...
                <div>
                    ...
                    <div class="text-sm mb-10">
                        <div class="space-y-2">
                            <p x-text="$store.deactivateModal.data.user_active === 1 ? 'You are about to deactivate this user account. Do you want to proceed?' : 'You are about to activate this user account. Do you want to proceed?'"></p>
                        </div>                        
                    </div>
                    <!-- Modal footer -->
