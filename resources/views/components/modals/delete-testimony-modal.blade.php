            ...
            <div class="p-5 flex space-x-4">
                ...
                <div>
                    ...
                    <div class="text-sm mb-10">
                        <div class="space-y-2">
                            <p>You are about to delete this testimony, this action cannot be undone. Do you want to proceed?</p>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="flex flex-wrap justify-end space-x-2">
                        ...
                        <form x-bind:action="`/testimonials/destroy/${$store.deleteModal.testimonyId}`" method="POST">
                            @csrf
                            @method('GET')
