                    ...
                    <div class="space-y-3 mt-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="sm:w-1/3">
                                ...
                                <input id="price" class="form-input w-full px-2 py-1" type="string" name="price"  />
                            </div>
                            <div class="sm:w-1/3">
                                <label class="block text-sm font-medium mb-1" for="duration">Course Duration (Weeks) <span class="text-red-500">*</span></label>
                                <input id="duration" class="form-input w-full px-2 py-1" type="number" name="duration"  />
                            </div>
                        </div>
                        <div class="flex gap-4">
                            <div class="sm:w-1/3">
                                <label class="block text-sm font-medium mb-1" for="theory_session">Theory Session (Hours) <span class="text-red-500">*</span></label>
                                <input id="theory_session" class="form-input w-full px-2 py-1" type="number" name="theory_session" />
                            </div>
                            <div class="sm:w-1/3">
                                ...
                                <input id="practical_session" class="form-input w-full px-2 py-1" type="number" name="practical_session" />
                            </div>
                            <div class="sm:w-1/3">
                                <label class="block text-sm font-medium mb-1" for="examination">Examination <span class="text-red-500">*</span></label>
                                <input id="examination" class="form-input w-full px-2 py-1" type="text" name="examination" placeholder="20 Mins+ 30 Mins"  />
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="flex gap-4">
                            <div class="sm:w-1/2">
                                <label class="block text-sm font-medium mb-1" for="image_url">Display Picture <span class="text-red-500">*</span> <span class="text-yellow-500 text-xs">370 x 250 px</span></label>
                        ...
                        <div>
                            ...
                            <input id="video_url" class="form-input w-full px-2 py-1" type="url" name="video_url" />
                        </div>
                    </div>
                </div>
