    ...
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                ...
                >
                    <ul>
                        <li>
                            <a class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">View</a>
                        </li>
                        <!-- <li>
        ...
        <div class="flex items-start">
            ...
            {{-- <div class="text-sm font-medium px-1.5 rounded-full 
                {{ $revenuePI >= 0 ? 'text-green-700 bg-green-500/20' : 'text-red-700 bg-red-500/20' }}">
                {{ number_format($revenuePI, 0) }}%
            </div> --}}
        </div>
    </div>
