...
function mixAssetsDir(query, cb) {
  (glob.sync('resources/backend_assets/assets/' + query) || []).forEach(f => {
    f = f.replace(/[\\\/]+/g, '/');
    cb(f, f.replace('resources/backend_assets/assets/', 'public/backend_assets/'));
  });
}
...
mix.copy('node_modules/boxicons/fonts/*', 'public/backend_assets/vendor/fonts/boxicons');
